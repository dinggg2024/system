  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 10px;">
      ...
      <div class="card" v-if="data.total">
        <el-pagination background layout="prev, pager, next" :page-size="data.pageSize" v-model:current-page="data.pageNum" :total="data.total" @current-change="load"/>
      </div>
    </div>

    <el-dialog title="图书分类" v-model="data.formVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="80px"  style="padding: 20px 30px" ref="formRef">
        <el-form-item label="类型名称" prop="name">
          <el-input v-model="data.form.name" placeholder="类型名称"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
